...
- ETF-Korrelationen: FMP prim�r, Fallback Stooq (CSV) bei fehlendem Key/Fehler ? Health `degraded`, leere Daten. Dev-Flag: `ETF_CORRELATIONS_DISABLED=true` zum Abschalten.
