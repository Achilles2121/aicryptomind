...
<!-- Update 2025-12-09: ETF correlations now fallback to Stooq when FMP missing (Health degraded, data leer), frontends show "ETF-Korrelationen aktuell nicht verfügbar" statt Crash. Trials werden bei erster Anmeldung in Firestore als elite_trial (7 Tage) angelegt, Countdown in UI. Dev-Ports: FE 5175, API 5176; Flag ETF_CORRELATIONS_DISABLED=true für lokalen Short-Circuit. -->
